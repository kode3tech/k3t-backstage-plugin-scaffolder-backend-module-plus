...
describe(`${ids_1.CATALOG_QUERY_ID} examples`, () => {
    const addLocation = jest.fn();
    const catalogClient = {
        addLocation: addLocation,
    };
    const action = (0, query_1.createCatalogQueryAction)({
    ...
    it('should register location in catalog', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield action.handler(Object.assign(Object.assign({}, mockContext), { input: yaml_1.default.parse(query_examples_1.examples[0].example).steps[0].input }));
