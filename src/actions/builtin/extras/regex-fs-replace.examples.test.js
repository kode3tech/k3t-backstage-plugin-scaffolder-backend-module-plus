...
describe(`${ids_1.REGEX_FS_REPLACE} examples`, () => {
    ...
    it('should register location in catalog', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield action.handler(Object.assign(Object.assign({}, mockContext), { input: yaml_1.default.parse(regex_fs_replace_examples_1.examples[0].example).steps[0].input }));
