...
const glob_examples_1 = require("./glob.examples");
const ids_1 = require("./ids");
describe(`${ids_1.GLOB} examples`, () => {
    const addLocation = jest.fn();
    const action = (0, glob_1.createGlobAction)();
    const mockContext = {
    ...
    it('should register location in catalog', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield action.handler(Object.assign(Object.assign({}, mockContext), { input: yaml_1.default.parse(glob_examples_1.examples[0].example).steps[0].input }));
