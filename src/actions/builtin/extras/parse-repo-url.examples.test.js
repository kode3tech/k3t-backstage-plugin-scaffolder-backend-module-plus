...
describe(`${ids_1.PARSE_REPO_URL} examples`, () => {
    ...
    it('should register location in catalog', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield action.handler(Object.assign(Object.assign({}, mockContext), { input: yaml_1.default.parse(parse_repo_url_examples_1.examples[0].example).steps[0].input }));
