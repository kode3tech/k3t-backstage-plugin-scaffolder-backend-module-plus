...
describe(`${ids_1.UUID_V4_GEN} examples`, () => {
    const addLocation = jest.fn();
    const action = (0, uuid_1.createUuidV4GenAction)();
    const mockContext = {
    ...
    it('should register location in catalog', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield action.handler(Object.assign(Object.assign({}, mockContext), { input: yaml_1.default.parse(uuid_examples_1.examples[0].example).steps[0].input }));
