...
const debug_fs_read_1 = require("./debug-fs-read");
const debug_fs_read_examples_1 = require("./debug-fs-read.examples");
const ids_1 = require("./ids");
describe(`${ids_1.DEBUG_FS_READ} examples`, () => {
    const addLocation = jest.fn();
    const action = (0, debug_fs_read_1.createDebugFsReadAction)({
    ...
    it('should register location in catalog', () => __awaiter(void 0, void 0, void 0, function* () {
        ...
        yield action.handler(Object.assign(Object.assign({}, mockContext), { input: yaml_1.default.parse(debug_fs_read_examples_1.examples[0].example).steps[0].input }));
