...
describe(`${ids_1.FETCH_PLAIN_FILE_ID} examples`, () => {
    ...
    it('should fetch plain', () => __awaiter(void 0, void 0, void 0, function* () {
        yield action.handler(Object.assign(Object.assign({}, mockContext), { input: yaml_1.default.parse(plainFile_examples_1.examples[0].example).steps[0].input }));
        expect(plugin_scaffolder_node_1.fetchFile).toHaveBeenCalledWith(expect.objectContaining({
            outputPath: (0, path_1.resolve)(mockContext.workspacePath, 'target-path'),
